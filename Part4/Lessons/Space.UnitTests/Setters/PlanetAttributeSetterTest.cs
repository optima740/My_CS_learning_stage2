...
{
    [TestClass]
    public class PlanetAttributeSetterTest
    {
        ...
        public void Setup()
        {
            ...
            _setter = new PlanetAttributeSetter(_printInConsoleMock.Object, _readFromConsoleMock.Object);
        }

        [Test]
        public void PlanetAttributeSetter_ShouldSetPlanetAttributes()
        {
            //Act
            _setter.SetAttributs(_planet);
        ...
        public void IncorrectInput_ShouldThrowExeption()
        {
            ...
            //Act
            var exception = NUnit.Framework.Assert.Throws<Exception>(() => _setter.SetAttributs(_planet));
